package main.java.iptv.core.filter;
...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain arg2)
        ...
        if ((servletPath.contains("/sys")) || (servletPath.contains("/admin")) || (servletPath.contains("/wf"))) {
            ...
            } else if ((servletPath.contains("/login")) || (servletPath.contains("/doLogin")) ||
            ...
            } else if ((requestType != null) && ("XMLHttpRequest".equalsIgnoreCase(requestType))) {
